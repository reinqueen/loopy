...
When a later interview answer refines a never-confirmed Product draft after Definition work has begun, preserve the active workspace and identities: reconcile the Living Roadmap, use Definition draft revalidation, then apply only the affected Definition meaning. Do not invoke material Change Management or rebuild the lifecycle for ordinary unconfirmed discovery.
