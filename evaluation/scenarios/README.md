...
The [collaborative brownfield discovery scenario](brownfield-discovery/collaborative/Scenario.md) exercises flexible entry, repository-informed Human grilling, evidence-versus-intent reconciliation, outcome grouping, dependency and priority reasoning, Roadmap updates, and direct Milestone Definition without adding a Requirements artifact.
